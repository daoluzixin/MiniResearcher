...
class vLLMRollout(BaseRollout):
    ...
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        # Prefer explicit max_model_len from config; fallback to prompt + response length
        ...
        # For vLLM >= 0.7, set_tokenizer is removed; tokenizer is set via constructor
        if hasattr(self.inference_engine, 'set_tokenizer'):
