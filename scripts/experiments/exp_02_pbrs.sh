...
# =============================================================================
# Experiment 02: PBRS — Potential-Based Reward Shaping
# =============================================================================
...
NUM_GPUS="${NUM_GPUS:-2}"
EXP_NAME="${EXP_NAME:-exp02_pbrs}"
PBRS_GAMMA="${PBRS_GAMMA:-0.5}"
...
echo "============================================================"
echo "  Experiment 02: PBRS — Potential-Based Reward Shaping"
echo "  PBRS gamma: $PBRS_GAMMA"
echo "============================================================"

LOG_FILE="${LOG_DIR}/${EXP_NAME}_gamma${PBRS_GAMMA}.log"
...
"$PYTHON_BIN" verl/trainer/main_ppo.py \
    ...
    trainer.experiment_name="${EXP_NAME}_gamma${PBRS_GAMMA}" \
    ...
    reward_model.pbrs_gamma="$PBRS_GAMMA" \
