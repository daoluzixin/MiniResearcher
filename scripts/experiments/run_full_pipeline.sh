...
# =============================================================================
# Full Pipeline: All Five Improvements Combined
# =============================================================================
...
NUM_GPUS="${NUM_GPUS:-2}"
EXP_NAME="${EXP_NAME:-exp_full_pipeline}"
...
echo "============================================================"
echo "  FULL PIPELINE: All Five Improvements Combined"
...
"$PYTHON_BIN" verl/trainer/main_ppo.py \
    ...
    reward_model.query_repetition_penalty_coef=0.05 \
    max_turns=5 \
    do_search=true \
    agent_grpo.n=2 \
