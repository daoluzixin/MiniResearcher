#!/bin/bash
# Exp-02_2f_Ours: Curriculum + Early-Stop Penalty + Entropy Bonus（全部机制）
# 机器: 1×A100-80GB (js1.blockelite.cn:32912)
# 与 baseline (run_exp_02_a100.sh) 的区别:
#   - reward_model.use_curriculum=True, curriculum_bonus_coef=0.1
...
python3 -m verl.trainer.main_ppo \
  data.train_files=/root/DeepResearcher/data/web_search_agent_25.parquet \
  data.val_files=/root/DeepResearcher/data/web_search_agent_25.parquet \
  ...
  trainer.experiment_name=gsm8k_2f_ours \
