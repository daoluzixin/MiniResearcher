...
# =============================================================================
# Experiment 03: Actor-LoRA + Frozen-Ref Weight Sharing
# =============================================================================
...
echo "============================================================"
echo "  Experiment 03: Actor-LoRA + Frozen-Ref Weight Sharing"
echo "  LoRA rank=$LORA_RANK, alpha=$LORA_ALPHA"
echo "============================================================"

LOG_FILE="${LOG_DIR}/${EXP_NAME}_rank${LORA_RANK}.log"
...
"$PYTHON_BIN" verl/trainer/main_ppo.py \
    ...
    trainer.experiment_name="${EXP_NAME}_rank${LORA_RANK}_alpha${LORA_ALPHA}" \
